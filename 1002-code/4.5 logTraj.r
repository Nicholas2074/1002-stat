...
logMorCrude <- glm(hospMortality ~ group, data = dfTrajMor, family = binomial)
...
logDisCrude <- glm(disgcs ~ group, data = dfTrajDis, family = binomial)
...
logDevCrude <- glm(devgcs ~ group, data = dfTrajDev, family = binomial)
